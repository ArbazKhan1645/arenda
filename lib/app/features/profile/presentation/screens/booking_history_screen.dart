...
class _BookingHistoryScreenState extends ConsumerState<BookingHistoryScreen>
  ...
  Widget build(BuildContext context) {
    final history = ref.read(bookingProvider.notifier).bookingHistory;
        ...
        bottom: history.isEmpty
            ...
            : PreferredSize(
                ...
                child: TabBar(
                  ...
                  labelStyle: AppTextStyles.labelSM.copyWith(fontSize: 13),
...
class _TripsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      separatorBuilder: (_, _) => const SizedBox(height: AppDimensions.spaceLG),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: _InfoCell(
                                  ...
                                  label: 'Total',
                                  value:
                                      'CFA ${(booking.totalPrice * 600).toInt()}',
  ...
  List<Widget> _buildTips(BuildContext context) {
    final tips = [
      (
        ...
        body:
            'Upload your Ghana Card, NIN, or Passport to unlock instant booking.',
        delay: 620,
      ),
      (
        ...
        body:
            'Properties in Lagos & Accra fill up fast — reserve 2+ weeks ahead.',
        delay: 680,
      ),
      (
        ...
        body:
            'Ask about check-in, parking, or local recommendations before you arrive.',
        delay: 740,
      ),
    ];
